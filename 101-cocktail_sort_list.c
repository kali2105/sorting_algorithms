...
/**
 * swap_node_ahead - Swapping fct for a node in a listint_t doubly-linked list
...
/**
 * swap_node_behind - Swapping function for a node in a listint_t doubly-linked
...
/**
 * cocktail_sort_list - A function that sorts a listint_t doubly-linked.list of
 * integers in ascending order using the cocktail shaker algorithm
 * @list: A pointer to the head of a listint_t doubly-linked.l
 */
void cocktail_sort_list(listint_t **list)
{
